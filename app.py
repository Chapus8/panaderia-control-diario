...
# ==========================================
# 3. FUNCIONES DE BASE DE DATOS Y PDF
# ==========================================
        ...
        if archivo_xml is not None:
            try:
                ...
                try: 
                    ...
                    root = ET.fromstring(xml_str.encode('ascii', 'ignore').decode('utf-8'))
                ...
                # Validar si el XML trae el NIT o Nombre de Oasis
